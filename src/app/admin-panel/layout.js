...
import Profile from "@/Component/admin/modules/Profile";
import AdminGuard from "@/app/admin-panel/AdminGuard";
    ...
    return (
        ...
        <div className="relative flex items-start justify-between">
            ...
            <div className={`transition-all duration-300 h-[95vw] bg-[#333] ${isCollapsed ? "w-[50px]" : "w-[240px]"}`}>
                                ...
                                <div onClick={() => setActiveItem("Dashboard")}
                                    ...
                                    <div
                                        ...
                                        <div className="p-3 rounded bg-[#2c3b41]">
                                            <Link href="/admin-panel/Dashboard/DashboardOne"
                                                  className="flex items-center text-[14px]">
                                                <FaRegCircle/>
                                                <span className="mr-2">داشبرد اول</span>
                                            </Link>
                                            <Link href="/admin-panel/Dashboard/DboaashrdTwo"
                            ...
                            <AnimatePresence initial={false}>
                                {isDashboardOpen && (
                                    ...
                                    >
                                        ...
                                        <Link
                                            href="/admin-panel/Dashboard/DashboardTwo"
                ...
                {isCollapsed ? (
                    <>
                        <Link onClick={() => setActiveItem("product")} href="/admin-panel/Product"
                ...
                {isCollapsed ? (
                    <>
                        <Link onClick={() => setActiveItem("Categories")} href="/admin-panel/Categories"
                ...
                {isCollapsed ? (
                    <>
                        <Link onClick={() => setActiveItem("Orders")} href="/admin-panel/Orders"
                              className="relative group flex items-center mt-2  p-3">
                ...
                {isCollapsed ? (
                    <>
                        <Link onClick={() => setActiveItem("Users")} href="/admin-panel/Users"
                              className="relative group flex items-center mt-2  p-3">
                            <PiUsersThreeBold/>
                            <div
                ...
                {isCollapsed ? (
                    <>
                        <Link onClick={() => setActiveItem("Warehouse")} href="/admin-panel/Warehouse"
                              className="relative group flex items-center mt-2  p-3">
                            <LuWarehouse/>
                            <div
                                className="hidden group-hover:flex absolute bg-[#1e282c] w-[150px] h-[40px] right-[50px] z-[90] flex items-center pr-2 rounded">
                ...
                {isCollapsed ? (
                    <>
                        <Link onClick={() => setActiveItem("Discounts")} href="/admin-panel/Discounts"
                              className="relative group flex items-center mt-2  p-3">
                            <MdDiscount/>
                            <div
                                className="hidden group-hover:flex absolute bg-[#1e282c] w-[150px] h-[40px] right-[50px] z-[90] flex items-center pr-2 rounded">
                ...
                {isCollapsed ? (
                    <>
                        <Link onClick={() => setActiveItem("Blogs")} href="/admin-panel/Blogs"
                              className="relative group flex items-center mt-2  p-3">
                            <PiGraphDuotone/>
                            <div
                                className="hidden group-hover:flex absolute bg-[#1e282c] w-[150px] h-[40px] z-[90] right-[50px] flex items-center pr-2 rounded">
                ...
                {isCollapsed ? (
                    <>
                        <Link onClick={() => setActiveItem("Pages")} href="/admin-panel/Pages"
                              className="relative group flex items-center mt-2  p-3">
                            <TfiBag/>
                            <div
                                className="hidden group-hover:flex absolute bg-[#1e282c] w-[150px] h-[40px] right-[50px] z-[90] flex items-center pr-2 rounded">
                ...
                {isCollapsed ? (
                    <>
                        <Link onClick={() => setActiveItem("Comments")} href="/admin-panel/Comments"
                              className="relative group flex items-center mt-2  p-3">
                            <IoLogoWechat/>
                            <div
                                className="hidden group-hover:flex absolute bg-[#1e282c] w-[150px] h-[40px] right-[50px] z-[90] flex items-center pr-2 rounded">
                ...
                {isCollapsed ? (
                    <>
                        <Link onClick={() => setActiveItem("Products_Comments")}
                              href="/admin-panel/Products_Comments"
                              className="relative group flex items-center mt-2  p-3">
                            <FaStar/>
                            <div
                                className="hidden group-hover:flex absolute bg-[#1e282c] w-[150px] h-[40px] right-[50px] z-[90] flex items-center pr-2 rounded">
                    ...
                    <Link onClick={() => setActiveItem("Products_Comments")} href="/admin-panel/Products_Comments"
                ...
                {isCollapsed ? (
                    <>
                        <Link onClick={() => setActiveItem("Banners")} href="/admin-panel/Banners"
                              className="relative group flex items-center mt-2  p-3">
                            <GiVerticalBanner/>
                            <div
                                className="hidden group-hover:flex absolute bg-[#1e282c] w-[150px] h-[40px] right-[50px] z-[90] flex items-center pr-2 rounded">
                ...
                {isCollapsed ? (
                    <>
                        <Link onClick={() => setActiveItem("ticket")} href="/admin-panel/ticket"
                              className="relative group flex items-center mt-2  p-3">
                            <IoTicketSharp/>
                            <div
                                className="hidden group-hover:flex absolute bg-[#1e282c] w-[150px] h-[40px] z-[90] right-[50px] flex items-center pr-2 rounded">
                ...
                {isCollapsed ? (
                    <>
                        <Link onClick={() => setActiveItem("About")} href="/admin-panel/About"
                              className="relative group flex items-center mt-2  p-3">
                            <IoIosMenu/>
                            <div
                                className="hidden group-hover:flex absolute bg-[#1e282c] w-[150px] h-[40px] z-[90] right-[50px] flex items-center pr-2 rounded">
                ...
                {isCollapsed ? (
                    <>
                        <Link onClick={() => setActiveItem("Settings")} href="/admin-panel/Settings"
                              className="relative group flex items-center mt-2  p-3">
                            <IoSettingsOutline/>
                            <div
                                className="hidden group-hover:flex absolute bg-[#1e282c] w-[150px] h-[40px] right-[50px] z-[90] flex items-center pr-2 rounded">
