...
function DeleteAdmins({deleteAdmins, setDeleteAdmins}) {

    const performDelete = async () => {
        try {
            const res = await axios.delete(`${BASE_URL}/users/${deleteAdmins.id}`, {
                headers: {
            ...
            if (res.status === 200) {
                ...
                setDeleteAdmins({show:false , id:null})
            }
        } catch (error) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-30">
            <div className="bg-white p-6 rounded-lg shadow-md w-[300px] text-center">
                ...
                <div className="flex justify-around mt-6">
                    <button
                        onClick={() => setDeleteAdmins({show: false, id: null})}
