...
import StatCard from "@/Component/admin/modules/StatCard";
import TableCellDiscount from "@/Component/admin/modules/TableCellDiscount";
import TableHeadDiscount from "@/Component/admin/modules/TableHeadDiscount";
import PopupDiscounts from "@/Component/admin/modules/PopupDiscounts";
import DiscountsCategories from "@/Component/admin/modules/DiscountsCategories";
import DiscountsMinMax from "@/Component/admin/modules/DiscountsMinMax";
import DiscountDelete from "@/Component/admin/modules/DiscountDelete";
import {Toaster} from "sonner";
import Link from "next/link";
import EditPageDiscounts from "@/Component/admin/templates/EditPageDiscounts";
    ...
    return (
        <div className="mt-28 z-10">
            ...
            <div className="mx-8 mt-5 flex items-center gap-4">
                <Link href="/admin-panel/Discounts/Add"
