...
import DeleteProducts from "@/Component/admin/modules/DeleteProducts";
import EditProducts from "@/Component/admin/modules/EditProducts";
import Cookies from "js-cookie";
import Image from "next/image";
import Pagination from "@/Component/admin/modules/Pagination";
    ...
    return (
        <div className="mt-28">
            ...
            <div className="flex items-center justify-start mr-8 mt-3">
                ...
                <Link href="/admin-panel/Product/add"
