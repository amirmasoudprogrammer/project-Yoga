...
import DeleteBlogs from "@/Component/admin/modules/DeleteBlogs";
import {Toaster} from "sonner";
import EditBlogs from "@/Component/admin/modules/EditBlogs";
import Cookies from "js-cookie";
import {CiImageOn} from "react-icons/ci";
import PopupImageBlogs from "@/Component/admin/modules/PopupImageBlogs";
    ...
    return (
        <div className="p-6 mt-28">
            ...
            <div className="flex items-start justify-start gap-4 w-full md:w-auto">
                <Link href="/admin-panel/Blogs/add"
