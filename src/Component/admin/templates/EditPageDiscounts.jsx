...
import InputFieldDiscounts from "@/Component/admin/modules/InputFieldDiscounts";
import DatePickerField from "@/Component/admin/modules/DatePickerField";
import Badge from "@/Component/admin/modules/Badge";
import SelectFieldDiscounts from "@/Component/admin/modules/SelectFieldDiscounts";
...
function EditPageDiscounts({ popupEdit, setPopupEdit }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post(`${BASE_URL}/v1/admin/discounts/${popupEdit.item.id}`, form, {
                headers: {
