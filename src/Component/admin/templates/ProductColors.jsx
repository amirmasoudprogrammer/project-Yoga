...
import EditColors from "@/Component/admin/modules/EditColors";
import ColorDelete from "@/Component/admin/modules/ColorDelete";
import {Toaster} from "sonner";
import PopupAddColors from "@/Component/admin/modules/PopupAddColors";
...
function ProductColors(props) {
    ...
    const fetchData = async () => {
        try {
            ...
            const res = await axios.get(`${BASE_URL}/v1/admin/colors`, {
