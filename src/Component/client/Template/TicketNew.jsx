    ...
    return (
        <>
            <>
                ...
                <div className="flex items-center md:mt-5 justify-center md:justify-start md:mr-10 text-[#59518C] md:text-[30px] font-bold">تیکت های جدید</div>
                <div className="mt-10 hidden md:flex flex-col w-[831px] mr-5">
                    <div className="border h-[650px] border border-slate-300 rounded-xl mr-2">
                        ...
                        <div className="text-start text-[12px] p-5 text-black border-b border-slate-300">
                            <span
                                className="font-medium">مشتری یابی میکنم و نتیجه خاصی نگرفته ام، باید چه کار کنم؟</span>
                            <p className="text-slate-500">
                                عدم نتیجه گیری از مشتری یابی به عوامل مختلفی بستگی دارد که باید بررسی شود. برای اینکه
                                بتوانیم بهتر کمک تان کنیم لطفا موارد زیر به طور کامل در یک تیکت به کوچ ارسال کنید. خدمات
                                شما
                                چیست؟ بازار هدف شما چه کسانی هستند؟ کجا پیام مشتری یابی ارسال می کنید؟ چند روز هست که به
                                صورت مستمر مشتری یابی می کنید؟ در مجموع چند پیام مشتری یابی ارسال کردید؟ آیا کسی به شما
                                جواب
                ...
                {isVisible && (
                    <div className="flex md:hidden mt-10 w-[280px]  flex-col items-start justify-center ">
                        ...
                        <div className="mt-5 -mr-5">
                            {faqList.map((faq, index) => (
                                <div key={faq.id} className="border border-slate-400 flex flex-col mt-2 rounded w-[312px] m-auto h-[74px] p-2">
                                    <span className="text-black text-[15px] font-medium">{faq.title}</span>
                                    <div onClick={() => {setSelectedFaq(faq);setShowPopup(true);}} className="flex mr-10 -mt-4 items-center cursor-pointer  justify-center text-[#007AFF]">
                        ...
                        <div className="mt-10 flex items-center justify-center flex-col">
                            ...
                            <div className="flex items-start -mr-5 justify-start mt-8 mb-10">
                                <form>
                                    <div className="text-black mr-2 flex  flex-col items-start justify-start">
                                        ...
                                        <input
                                            ...
                                            className=" mt-2 w-[312px] outline-0 border border-slate-400 rounded "
                                            type="text"/>
                                    </div>
                                    <div className="text-black mr-2 flex flex-col mt-2 items-start justify-start">
                                        ...
                                        <select
                                            name="category_id"
                                            id="department"
                                            className=" mt-2 w-[312px] text-[12px] outline-0 border border-slate-400 rounded">
                                            <option value="">لطفاً یک دپارتمان را انتخاب کنید</option>
                                    ...
                                    <div className="text-black mr-2 flex flex-col items-start justify-start">
                                        ...
                                        <textarea
                                            ...
                                            className=" mt-2 w-[312px] h-[125px] outline-0 border border-slate-400 rounded resize-none"></textarea>
                                    </div>
